...
const urlPathMap = {
    whatIsTech: "apiintegrationwhatistech",
    whyItMatters: "apiintegrationwhyitmatters",
    realWorldUseCase: "apiintegrationrealworldusecase",
    howItWorks: "apiintegrationhowitworks",
    whoIsItFor: "apiintegrationwhoisitfor",
    realWorldImpact: "apiintegrationrealworldimpact",
    howItHelps: "apiintegrationhowithelps",
    faqs: "apiintegrationfaqs",
    contact: "apiintegrationcontact",
    hero: "apiintegrationhero"
};
