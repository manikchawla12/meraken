...
const urlPathMap = {
    whatIsTech: "uxdesignwhatistech",
    whyItMatters: "uxdesignwhyitmatters",
    realWorldUseCase: "uxdesignrealworldusecase",
    howItWorks: "uxdesignhowitworks",
    whoIsItFor: "uxdesignwhoisitfor",
    realWorldImpact: "uxdesignrealworldimpact",
    howItHelps: "uxdesignhowithelps",
    faqs: "uxdesignfaqs",
    contact: "uxdesigncontact",
    hero: "uxdesignhero"
};
