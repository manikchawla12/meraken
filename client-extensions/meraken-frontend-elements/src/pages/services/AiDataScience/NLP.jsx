...
const urlPathMap = {
    whatIsTech: "nlpwhatistech",
    whyItMatters: "nlpwhyitmatters",
    realWorldUseCase: "nlprealworldusecase",
    howItWorks: "nlphowitworks",
    whoIsItFor: "nlpwhoisitfor",
    realWorldImpact: "nlprealworldimpact",
    howItHelps: "nlphowithelps",
    faqs: "nlpfaqs",
    contact: "nlpcontact",
    hero: "nlphero"
};
