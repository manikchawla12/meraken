...
const urlPathMap = {
    whatIsTech: "dataannotationwhatistech",
    whyItMatters: "dataannotationwhyitmatters",
    realWorldUseCase: "dataannotationrealworldusecase",
    howItWorks: "dataannotationhowitworks",
    whoIsItFor: "dataannotationwhoisitfor",
    realWorldImpact: "dataannotationrealworldimpact",
    howItHelps: "dataannotationhowithelps",
    faqs: "dataannotationfaqs",
    contact: "dataannotationcontact",
    hero: "dataannotationhero"
};
